...
function hook_blueprint(): array
{
    ...
    return [
        'code'=>'HOOK','short_code'=>'HOOK','name'=>'Hook',
        'description'=>'Dedicated landscape register certificate for thorough examination of hooks.',
        'validity_months'=>6,'certificate_template'=>'Certificate of Thorough Examination',
        'template_family'=>'hook','layout_key'=>'hook-landscape-v1',
        'source_sample'=>'HOOK.jpg','schema_version'=>2,'theme_color'=>'#1565C0','identifier_label'=>'Certificate Number',
        'fields'=>[
            $field('report_date','Date of Report','date',false,5,'certificate','Defaults to examination date.'),
        ...
        'sections'=>[[
            'section_key'=>'hook_items','label'=>'Hook Examination Register',
            'help_text'=>'Add one row for each hook covered by this certificate. Maximum six rows per one-page certificate.',
